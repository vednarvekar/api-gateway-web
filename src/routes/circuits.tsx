...
export default function CircuitsPage() {
  const [data, setData] = useState<Awaited<ReturnType<typeof getCircuits>>>([]);

  useEffect(() => {
    document.title = "Circuits · API Gateway";
  }, []);
            ...
            >
              {c.state !== "closed" && (
                <div
                  ...
                  style={{
                    background:
                      c.state === "open" ? "var(--color-destructive)" : "var(--color-warning)",
                  }}
                />
              )}
